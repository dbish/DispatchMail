        ...
        <div className="modal awaiting-human-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal-footer">
            <div className="compose-footer-left">
              <button className="quick-action-btn" onClick={handleRerun} disabled={isRerunning || isSending}>
                {isRerunning ? 'Regenerating...' : 'Regenerate'}
              </button>
              <button className="quick-action-btn delete-action" onClick={handleDelete} disabled={isSending}>
                Delete Draft
              </button>
            </div>
