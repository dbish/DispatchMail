              ...
              <div className="settings-panel-content">
                <div className="settings-section">
                  ...
                  <div className="settings-field">
                    ...
                    <textarea className="settings-textarea" value={draftPrompt} onChange={(e) => setDraftPrompt(e.target.value)} placeholder="Customize how the AI should write responses..." rows={4} />
                  </div>
                  <div className="settings-field">
                    <label>Actual LLM Prompt (Debug)</label>
                    <textarea className="settings-textarea readonly" value={llmPrompt} readOnly placeholder="The actual content sent to the LLM..." rows={6} />
                  </div>
                </div>
              </div>
            </div>
